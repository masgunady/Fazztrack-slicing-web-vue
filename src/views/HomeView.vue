...
<template>
      ...
      <div class="max-w-[1080px] flex flex-col justify-center items-center gap-9">
        <div class="w-full flex flex-col-reverse lg:flex-row items-center justify-between gap-11 pb-7">
          <div class="flex flex-col gap-11 w-full lg:w-[70%]">
            <div>
              <div class="text-5xl font-bold text-primary pb-2 text-center lg:text-left">
                Ubah Hidupmu
              </div>
    ...
    <section class="w-full flex flex-col justify-center items-center gap-11 md:py-16">
      <div class="w-full flex flex-col-reverse md:flex-row justify-between items-center gap-5 bg-slate-300 max-w-[1080px] p-14 md:rounded-3xl">
    ...
    <section class="w-full flex flex-col justify-center items-center gap-11 py-11 bg-secondary">
      <div class="w-full max-w-[1080px] text-black flex flex-col gap-3 pb-16">
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-4 px-7 lg:px-0">
          <div class="bg-secondary w-full sm:w-[80%] md:w-[320px] md:h-[320px] rounded-xl p-5 flex flex-col justify-center gap-4">
    ...
    <section class="w-full h-72 bg-primary/10 flex flex-col justify-center items-center gap-11">
        ...
        <RouterLink to="/" class="btn btn-primary text-white capitalize font-semibold text-lg">
            Daftar Sekarang
        </RouterLink>
    </section>
    <FoterComponent/>
